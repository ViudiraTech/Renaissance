...
import com.renaisce.particle.Particle;
...
public class Tile {
	...
	public static Tile stoneBrick = new Tile(4, 4);
	public static Tile wood = new Tile(5, 5);
	public static Tile test = new Tile(5, 6);
